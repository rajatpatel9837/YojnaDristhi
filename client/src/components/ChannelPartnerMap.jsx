...
import { MapPin, Navigation, Phone, Clock, CheckCircle2, Building2, ShieldCheck } from 'lucide-react';
            ...
            >
              ...
              {partners.map((partner, idx) => {
                ...
                return (
                  ...
                  >
                    <Popup>
                      <div className="p-1 text-[#173B57] font-sans text-xs">
                        <div className="font-bold">{partner.name}</div>
                        <div className="text-[11px] text-slate-500">{partner.address}</div>
                        <div className="mt-1 text-[10px] bg-[#CCFBF1] text-[#115E59] font-bold px-1.5 py-0.5 rounded inline-block">
                          {partner.suitabilityScore}% Suitability
                        </div>
                      </div>
                    </Popup>
                  </Marker>
