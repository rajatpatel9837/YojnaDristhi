        ...
        <div className="p-5 sm:p-6 overflow-y-auto space-y-6 text-xs">
            ...
            <div className="space-y-1 text-center sm:text-left">
              ...
              <p className="text-[11px] text-slate-400">
                {isHindi ? (
                  ...
                  <>Standalone single scheme provides only <span className="line-through text-slate-500">{bundle.standaloneSavings_hi}</span>.</>
                )}
              </p>
            </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[11px] text-emerald-400 font-bold">{isHindi ? 'योजनाओं का 1-साथ लाभ' : 'Multi-Scheme Advantage'}</span>
            </div>
